...
func TestTagAndDenormalizeDeserializeFileCriteria(t *testing.T) {
	...
	err := scriptDef.Deserialize(
		[]byte(re.ReplaceAllString(scriptJson, `"tag_criteria_url": "../../../test/data/cfg/tag_and_denormalize/tag_criteria.json"`)), sc.ScriptJson,
...
func TestTagAndDenormalizeRunEmbeddedCriteria(t *testing.T) {
	...
	rs := proc.NewRowsetFromFieldRefs(sc.FieldRefs{
		{TableName: "r", FieldName: "product_id", FieldType: evalcapi.FieldTypeInt},
		{TableName: "r", FieldName: "name", FieldType: evalcapi.FieldTypeString},
		{TableName: "r", FieldName: "price", FieldType: evalcapi.FieldTypeDecimal2},
		{TableName: "r", FieldName: "product_spec", FieldType: evalcapi.FieldTypeString},
	})
