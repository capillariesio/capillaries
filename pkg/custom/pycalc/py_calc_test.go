...
func testCalculator(t *testing.T, scriptDef *sc.ScriptDef) {
	...
	rs := proc.NewRowsetFromFieldRefs(sc.FieldRefs{
		{TableName: "r", FieldName: "field_int1", FieldType: evalcapi.FieldTypeInt},
		{TableName: "r", FieldName: "field_float1", FieldType: evalcapi.FieldTypeFloat},
		{TableName: "r", FieldName: "field_decimal1", FieldType: evalcapi.FieldTypeDecimal2},
		{TableName: "r", FieldName: "field_string1", FieldType: evalcapi.FieldTypeString},
		{TableName: "r", FieldName: "field_bool1", FieldType: evalcapi.FieldTypeBool},
		{TableName: "r", FieldName: "field_dt1", FieldType: evalcapi.FieldTypeDateTime},
	})
...
func TestPythonResultToRowsetValueFailures(t *testing.T) {
	_, err := pythonResultToRowsetValue(&sc.FieldRef{TableName: "p", FieldName: "field_int1", FieldType: evalcapi.FieldTypeInt}, true)
	assert.Contains(t, err.Error(), "int field_int1, unexpected type bool(true)")
	_, err = pythonResultToRowsetValue(&sc.FieldRef{TableName: "p", FieldName: "field_float1", FieldType: evalcapi.FieldTypeFloat}, true)
	assert.Contains(t, err.Error(), "float field_float1, unexpected type bool(true)")
	_, err = pythonResultToRowsetValue(&sc.FieldRef{TableName: "p", FieldName: "field_decimal1", FieldType: evalcapi.FieldTypeDecimal2}, true)
	assert.Contains(t, err.Error(), "decimal field_decimal1, unexpected type bool(true)")
	_, err = pythonResultToRowsetValue(&sc.FieldRef{TableName: "p", FieldName: "field_string1", FieldType: evalcapi.FieldTypeString}, true)
	assert.Contains(t, err.Error(), "string field_string1, unexpected type bool(true)")
	_, err = pythonResultToRowsetValue(&sc.FieldRef{TableName: "p", FieldName: "field_datetime1", FieldType: evalcapi.FieldTypeDateTime}, true)
	assert.Contains(t, err.Error(), "time field_datetime1, unexpected type bool(true)")
	_, err = pythonResultToRowsetValue(&sc.FieldRef{TableName: "p", FieldName: "field_datetime1", FieldType: evalcapi.FieldTypeDateTime}, "aaa")
	assert.Contains(t, err.Error(), "bad time result field_datetime1, unexpected format aaa")
	_, err = pythonResultToRowsetValue(&sc.FieldRef{TableName: "p", FieldName: "field_bool1", FieldType: evalcapi.FieldTypeBool}, "aaa")
