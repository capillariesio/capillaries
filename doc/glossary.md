...
go run toolbelt.go get_run_status_diagram -script_file=../../../test/lookup/script.json -params_file=../../../test/lookup/script_params_two_runs.json -keyspace=test_lookup -run_id=1
```
