...
if [[ $OUT_FILE == *html ]]; then
	...
	table2html quarterly_project_budget 2_calc_quarterly_budget $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2html quarterly_project_budget_tagged_by_country 3_tag_countries $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2html quarterly_project_budget_tagged_by_sector 3_tag_sectors $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2html quarterly_project_budget_tagged_by_country_quarter 4_tag_countries_quarter $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2html quarterly_project_budget_tagged_by_sector_quarter 4_tag_sectors_quarter $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2html quarterly_project_budget_tagged_by_partner_quarter 4_tag_partners_quarter $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	...
	table2md quarterly_project_budget 2_calc_quarterly_budget $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2md quarterly_project_budget_tagged_by_country 3_tag_countries $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2md quarterly_project_budget_tagged_by_sector 3_tag_sectors $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2md quarterly_project_budget_tagged_by_country_quarter 4_tag_countries_quarter $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2md quarterly_project_budget_tagged_by_sector_quarter 4_tag_sectors_quarter $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
	table2md quarterly_project_budget_tagged_by_partner_quarter 4_tag_partners_quarter $SCRIPT_JSON $OUT_FILE global_affairs_quicktest
