...
locals {
  cassandra_provisioner_common_vars = "SSH_USER=${var.ssh_user} S3_LOG_URL=${var.s3_log_url} CASSANDRA_VERSION=${var.cassandra_version} CASSANDRA_HOSTS=${local.cassandra_hosts}"
