...
func main() {
	...
	fileScriptParams := "./script_params_one_run.json"
	...
	fileInOrdersPath := flag.String("in_orders", "./data/in/raw_orders", "Path to input file to generate: orders")
	fileInItemsPath := flag.String("in_items", "./data/in/raw_items", "Path to input file to generate: order items")
	fileOutNoGroupInnerPath := flag.String("out_no_group_inner", "./data/out/raw_no_group_inner", "Path to output file to generate: orders inner joined with items, no grouping")
	fileOutNoGroupLeftOuterPath := flag.String("out_no_group_left_outer", "./data/out/raw_no_group_outer", "Path to output file to generate: orders left outer joined with items, no grouping")
	fileOutGroupInnerPath := flag.String("out_group_inner", "./data/out/raw_grouped_inner", "Path to output file to generate: orders inner joined with items, grouped")
	fileOutGroupLeftOuterPath := flag.String("out_group_left_outer", "./data/out/raw_grouped_outer", "Path to output file to generate: orders left outer joined with items, grouped")
