...
Capillaries-UI is a simple [SPA](https://en.wikipedia.org/wiki/Single-page_application) that provides user access to Capillaries environment (message queue and Cassandra storage) using [Webapi](../doc/glossary.md#webapi)
